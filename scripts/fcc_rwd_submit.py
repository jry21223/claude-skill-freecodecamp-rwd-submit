...
JS_IS_CHALLENGE_TEST = "/freecodecamp\\.org\\/(?:chinese\\/)?learn\\/2022\\/responsive-web-design\\//.test(location.href)"
...
def is_valid_challenge_url(url: Any) -> bool:
    return isinstance(url, str) and "/step-" in url and re.search(r"freecodecamp\.org/(?:chinese/)?learn/2022/responsive-web-design/", url) is not None
